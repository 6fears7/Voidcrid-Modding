...
//         private string path = "RoR2/Base/Croco/CrocoBody.prefab";
...
//            LanguageAPI.Add("PASSIVEAGRESSION_NONE","blarg");
//            LanguageAPI.Add("PASSIVEAGRESSION_NONE_DESC","Noasdfthing");
//            NoneDef = ScriptableObject.CreateInstance<SkillDef>();
//            NoneDef.skillNameToken = "asdf";
//            (NoneDef as ScriptableObject).name = NoneDef.skillNameToken;
//            NoneDef.skillDescriptionToken = "ffff";
